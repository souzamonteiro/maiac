...
const sourcePath = path.join(repoRoot, 'compiler', 'examples', 'simple_add.c');
const wasmOutPath = path.join(repoRoot, 'compiler', 'examples', 'simple_add.wasm');
const watOutPath = path.join(repoRoot, 'compiler', 'examples', 'simple_add.wat');

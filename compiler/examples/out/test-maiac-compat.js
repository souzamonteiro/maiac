...
(function buildEnv(getMemory) {
  ...
  return {
    ...
    "__Math__cbrt": (p0) => Math.cbrt(p0),
    "__Math__abs": (p0) => Math.abs(p0),
    "__Math__ceil": (p0) => Math.ceil(p0),
    "__Math__floor": (p0) => Math.floor(p0),
    "__Math__round": (p0) => Math.round(p0),
    "__Math__trunc": (p0) => Math.trunc(p0),
    "__Math__sin": (p0) => Math.sin(p0),
    "__Math__cos": (p0) => Math.cos(p0),
    "__Math__tan": (p0) => Math.tan(p0),
    "__Math__asin": (p0) => Math.asin(p0),
    "__Math__acos": (p0) => Math.acos(p0),
    "__Math__atan": (p0) => Math.atan(p0),
    "__Math__exp": (p0) => Math.exp(p0),
    "__Math__log": (p0) => Math.log(p0),
    "__Math__log2": (p0) => Math.log2(p0),
    "__Math__log10": (p0) => Math.log10(p0),
    "__Math__pow": (p0, p1) => Math.pow(p0, p1),
    "__Math__min": (p0, p1) => Math.min(p0, p1),
    "__Math__max": (p0, p1) => Math.max(p0, p1),
    "__Math__random": () => Math.random(),
    "__alert": (p0) => alert(readCString(p0)),
  };
});
const _linkedLibraries = ["maiac_compat"];

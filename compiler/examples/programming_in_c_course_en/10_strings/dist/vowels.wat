...
(module
  ...
  (data (i32.const 44) "Your name has %d vowels.\0a\00")

  (elem (table $fn_table) (i32.const 0) func $count_vowels $main)

  ;; function count_vowels
  (func $count_vowels (param $name i32) (result i32)
    (local $__frame i32)
    (local $i i32)
    (local $n i32)
    (local $__tmp_i32 i32)
    ...
    local.get $__tmp_i32
    drop
    block $count_vowels_for_exit_0
      loop $count_vowels_for_loop_2
        local.get $__frame
        i32.const 4
        i32.add
        i32.load
        ...
        i32.eqz
        i32.eqz
        br_if $count_vowels_for_exit_0
        block $count_vowels_for_continue_1
          local.get $__frame
          i32.const 0
          i32.add
          i32.load
  ...
  (export "count_vowels" (func $count_vowels))

...
(module
  ...
  (data (i32.const 32) "%49s\00")
  (data (i32.const 40) "The word is a palindrome!\00")
  (data (i32.const 68) "The word is not a palindrome!\00")

  (elem (table $fn_table) (i32.const 0) func $is_palindrome $main)

  ;; function is_palindrome
  (func $is_palindrome (param $word i32) (result i32)
    (local $__frame i32)
    (local $i i32)
    (local $j i32)
    (local $result i32)
    ...
    local.get $__tmp_i32
    drop
    block $is_palindrome_for_exit_0
      loop $is_palindrome_for_loop_2
        local.get $__frame
        i32.const 4
        i32.add
        i32.load
        ...
        i32.eqz
        i32.eqz
        br_if $is_palindrome_for_exit_0
        block $is_palindrome_for_continue_1
          local.get $__frame
          i32.const 0
          i32.add
          i32.load

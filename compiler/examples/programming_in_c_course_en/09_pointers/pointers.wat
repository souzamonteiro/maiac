...
(module
  (import "env" "toupper" (func $imp_toupper (param i32) (result i32)))
  ...
  (data (i32.const 36) "%19s\00")
  (data (i32.const 44) "Hello %s!\0a\00")
  (data (i32.const 56) ">>\00")
  (data (i32.const 60) "%c\00")
  (data (i32.const 64) "<<\0a\00")
  (data (i32.const 68) "Your name has %d characters.\0a\00")
  (data (i32.const 100) "Your name has %lu characters.\0a\00")
  (data (i32.const 132) "Your name in uppercase is %s.\0a\00")

  (elem (table $fn_table) (i32.const 0) func $length $to_uppercase $main)

  ;; function length
  (func $length (param $txt i32) (result i32)
    (local $__frame i32)
    (local $n i32)
    (local $__tmp_i32 i32)
    ...
    local.get $__tmp_i32
    drop
    block $length_while_exit_0
      loop $length_while_loop_1
        local.get $__frame
        i32.const 0
        i32.add
        i32.load
  ...
  (func $to_uppercase (param $source i32) (param $dest i32)
    (local $__frame i32)
    (local $p i32)
    (local $q i32)
    (local $__tmp_i32 i32)
    ...
    local.get $__tmp_i32
    drop
    block $to_uppercase_while_exit_0
      loop $to_uppercase_while_loop_1
        local.get $__frame
        i32.const 8
        i32.add
        i32.load
        ...
        i32.eqz
        i32.eqz
        br_if $to_uppercase_while_exit_0
        local.get $__frame
        i32.const 12
        i32.add
        i32.load
  ...
  (export "to_uppercase" (func $to_uppercase))

...
(module
  ...
  (data (i32.const 16) "Address pointed to by pi: %p, value at that address: %d\0a\00")
  (data (i32.const 76) "Address pointed to by pf: %p, value at that address: %f\0a\00")
  (data (i32.const 136) "Address pointed to by pc: %p, value at that address: %c\0a\00")
  (data (i32.const 196) "%s\0a\00")
